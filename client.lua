...
DoAcid = function(time)
  local song = (time and time >= 90000 and 2 or 1)
...
InitCubes = function()
  ...
  while tick < counter do
    ...
    ShakeGameplayCam('DRUNK_SHAKE', math.min(0.1 * (tick/(counter/40)),1.49))
...
-- Joint Effect
RegisterNetEvent('acidtrip:joint')
AddEventHandler('acidtrip:joint', function()
...
RegisterNetEvent('acidtrip:lsd')
AddEventHandler('acidtrip:lsd', function()
  local QBCore = exports['qb-core']:GetCoreObject()
  QBCore.Functions.Progressbar("use_acid", "Poppin Acid", 3000, false, true, {
...
RegisterNetEvent('acidtrip:lsd2')
AddEventHandler('acidtrip:lsd2', function()
  local QBCore = exports['qb-core']:GetCoreObject()
  QBCore.Functions.Progressbar("use_acid2", "Poppin Acid", 3000, false, true, {
    disableMovement = false,
    disableCarMovement = false,
disableMouse = false,
disableCombat = true,
...
Citizen.Wait(8000)
	local playerPed = PlayerPedId()
				...
				Wait(10500)
				ShakeGameplayCam('SMALL_EXPLOSION_SHAKE', 0.15)
				Citizen.Wait(5*10500)
				ClearTimecycleModifier()
    end)

    --shitty acid

      RegisterNetEvent('acidtrip:lsd3')
      AddEventHandler('acidtrip:lsd3', function()
     local QBCore = exports['qb-core']:GetCoreObject()
     QBCore.Functions.Progressbar("use_acid3", "Poppin Acid", 3000, false, true, {
     disableMovement = false,
     disableCarMovement = false,
     disableMouse = false,
     disableCombat = true,
...
RegisterNetEvent('fent:M30')
AddEventHandler('fent:M30', function()
  local QBCore = exports['qb-core']:GetCoreObject()
  QBCore.Functions.Progressbar("pop_M30", "Poppin an Oxy", 3000, false, true, {
    disableMovement = false,
    disableCarMovement = false,
disableMouse = false,
disableCombat = true,
...
RegisterNetEvent('fent:xanax2')
AddEventHandler('fent:xanax2', function()
  local QBCore = exports['qb-core']:GetCoreObject()
  QBCore.Functions.Progressbar("pop_M30", "Poppin an Xanax", 3000, false, true, {
    disableMovement = false,
    disableCarMovement = false,
disableMouse = false,
disableCombat = true,
...
RegisterNetEvent('fent:xanax')
AddEventHandler('fent:xanax', function()
  local QBCore = exports['qb-core']:GetCoreObject()
  QBCore.Functions.Progressbar("pop_M30", "Poppin an Xanax", 3000, false, true, {
    disableMovement = false,
    disableCarMovement = false,
...
RegisterNetEvent('fent:perc302')
AddEventHandler('fent:perc302', function()
  local QBCore = exports['qb-core']:GetCoreObject()
  QBCore.Functions.Progressbar("pop_M30", "Poppin a Percocet", 3000, false, true, {
    disableMovement = false,
    disableCarMovement = false,
disableMouse = false,
disableCombat = true,
...
RegisterNetEvent('fent:perc30')
AddEventHandler('fent:perc30', function()
  local QBCore = exports['qb-core']:GetCoreObject()
  QBCore.Functions.Progressbar("pop_M30", "Poppin an Percocet", 3000, false, true, {
    disableMovement = false,
    disableCarMovement = false,
disableMouse = false,
disableCombat = true,
...
RegisterNetEvent('bagof:pills')
AddEventHandler('bagof:pills', function()
  local QBCore = exports['qb-core']:GetCoreObject()
  QBCore.Functions.Progressbar("pop_M30", "Counting pills.", 6000, false, true, {
    disableMovement = false,
    disableCarMovement = false,
disableMouse = false,
disableCombat = true,
...
RegisterNetEvent('bagof:pills2')
AddEventHandler('bagof:pills2', function()
  local QBCore = exports['qb-core']:GetCoreObject()
  QBCore.Functions.Progressbar("pop_M30", "Counting pills.", 6000, false, true, {
    disableMovement = false,
    disableCarMovement = false,
...
RegisterNetEvent('bagof:pills3')
AddEventHandler('bagof:pills3', function()
  local QBCore = exports['qb-core']:GetCoreObject()
  QBCore.Functions.Progressbar("pop_M30", "Counting pills.", 6000, false, true, {
    disableMovement = false,
    disableCarMovement = false,
